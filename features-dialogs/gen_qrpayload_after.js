...
module.exports = function afterqrpayload(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`qrpayload`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterqrpayload`)(
        `qrpayload${strAfterscriptdone}`,
