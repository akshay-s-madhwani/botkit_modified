...
module.exports = function beforeTestHellodefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`TestHello`, `default`, async (convo, bot) => {
      ...
      // map all cms.TestHello.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeTestHellodefault`)(
