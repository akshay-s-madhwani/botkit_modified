...
module.exports = function beforePayloadInterruptCodEonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`PAYLOAD_INTERRUPT_CODE`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.PAYLOAD_INTERRUPT_CODE.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforePayloadInterruptCodEonTimeout`)(
        `before PAYLOAD_INTERRUPT_CODE all convo.vars : `,
        convo.vars
      );
