...
module.exports = function beforePayloadInterruptCodEdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`PAYLOAD_INTERRUPT_CODE`, `default`, async (convo, bot) => {
      ...
      // map all cms.PAYLOAD_INTERRUPT_CODE.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforePayloadInterruptCodEdefault`)(
