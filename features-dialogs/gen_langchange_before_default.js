...
module.exports = function beforelangchangedefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`langchange`, `default`, async (convo, bot) => {
      ...
      // map all cms.langchange.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforelangchangedefault`)(
