...
module.exports = function beforeFacebookTestonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Facebook_Test`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.Facebook_Test.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeFacebookTestonTimeout`)(
        `before Facebook_Test all convo.vars : `,
        convo.vars
      );
