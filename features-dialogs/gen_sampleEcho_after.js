...
module.exports = function aftersampleEcho(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`sampleEcho`, async (results, bot) => {
      ...
      controller.debug(`testing:after:aftersampleEcho`)(
        `sampleEcho${strAfterscriptdone}`,
