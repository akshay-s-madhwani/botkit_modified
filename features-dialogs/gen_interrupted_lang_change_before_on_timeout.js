...
module.exports = function beforeinterruptedLangChangeonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interrupted_lang_change`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.interrupted_lang_change.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptedLangChangeonTimeout`)(
