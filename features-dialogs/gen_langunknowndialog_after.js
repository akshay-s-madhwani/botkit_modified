...
module.exports = function afterlangunknowndialog(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`langunknowndialog`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterlangunknowndialog`)(
        `langunknowndialog${strAfterscriptdone}`,
