...
module.exports = function beforeinterruptsdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interrupts`, `default`, async (convo, bot) => {
      ...
      // map all cms.interrupts.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptsdefault`)(
