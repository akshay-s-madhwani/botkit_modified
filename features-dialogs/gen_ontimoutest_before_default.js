...
module.exports = function beforeontimoutestdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`ontimoutest`, `default`, async (convo, bot) => {
      ...
      const cmstokens = [[`str_customizeme_text1`, {}]];
      ...
      // map all cms.ontimoutest.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeontimoutestdefault`)(
