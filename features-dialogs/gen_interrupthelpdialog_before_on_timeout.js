...
module.exports = function beforeinterrupthelpdialogonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interrupthelpdialog`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.interrupthelpdialog.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterrupthelpdialogonTimeout`)(
