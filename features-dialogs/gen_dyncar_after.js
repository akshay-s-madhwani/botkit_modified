...
module.exports = function afterdyncar(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`dyncar`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterdyncar`)(
        `dyncar${strAfterscriptdone}`,
