...
module.exports = function beforeAkhashonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Akhash`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.Akhash.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeAkhashonTimeout`)(
        `before Akhash all convo.vars : `,
        convo.vars
      );
