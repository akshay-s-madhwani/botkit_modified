...
module.exports = function afterlangchange(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`langchange`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterlangchange`)(
        `langchange${strAfterscriptdone}`,
