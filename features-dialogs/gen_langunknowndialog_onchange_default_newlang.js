...
module.exports = function onchangelangunknowndialognewlang(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.onChange(`langunknowndialog`, `newlang`, async (nv, convo, bot) => {
      ...
      controller.debug(`testing:cms:langunknowndialog`)(
        `A new value got set for newlang inside langunknowndialog : `,
        nv
      );
      ...
      controller.debug(`testing:onchange:onchangelangunknowndialognewlang`)(
