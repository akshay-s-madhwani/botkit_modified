...
module.exports = function onchangeqrpayloadqrval(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.onChange(`qrpayload`, `qrval`, async (nv, convo, bot) => {
      ...
      controller.debug(`testing:cms:qrpayload`)(
        `A new value got set for qrval inside qrpayload : `,
        nv
      );

      const i18nvar = [[`str_valuegotset`, { valname: `qrval`, value: nv }]];
      ...
      controller.debug(`testing:onchange:onchangeqrpayloadqrval`)(
        `onchange qrval all convo.vars : `,
        convo.vars
      );
