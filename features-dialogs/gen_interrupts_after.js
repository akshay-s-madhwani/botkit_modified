...
module.exports = function afterinterrupts(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`interrupts`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterinterrupts`)(
        `interrupts${strAfterscriptdone}`,
