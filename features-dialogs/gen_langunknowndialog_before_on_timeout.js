...
module.exports = function beforelangunknowndialogonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`langunknowndialog`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.langunknowndialog.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforelangunknowndialogonTimeout`)(
