...
module.exports = function beforeinterruptquitdialogdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interruptquitdialog`, `default`, async (convo, bot) => {
      ...
      // map all cms.interruptquitdialog.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptquitdialogdefault`)(
