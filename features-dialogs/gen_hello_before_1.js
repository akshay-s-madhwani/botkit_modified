...
module.exports = function beforehello1(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`hello`, `1`, async (convo, bot) => {
      ...
      // map all cms.hello.1 mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforehello1`)(`before hello all convo.vars : `, convo.vars);
