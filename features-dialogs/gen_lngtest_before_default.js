...
module.exports = function beforelngtestdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`lngtest`, `default`, async (convo, bot) => {
      ...
      // map all cms.lngtest.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforelngtestdefault`)(
