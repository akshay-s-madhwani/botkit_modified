...
module.exports = function beforeinterruptedLangChangedefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interrupted_lang_change`, `default`, async (convo, bot) => {
      ...
      const cmstokens = [
        [`str_interrupted_lang_change`, { newlang: `tobedefinedbycodenewlang` }],
        [`str_interrupted_lang_change1`, { newlang: `tobedefinedbycodenewlang` }],
      ];
      ...
      // map all cms.interrupted_lang_change.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptedLangChangedefault`)(
        `before interrupted_lang_change all convo.vars : `,
        convo.vars
      );
