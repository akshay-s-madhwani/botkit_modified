...
module.exports = function beforebotgetstartedonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`botgetstarted`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.botgetstarted.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforebotgetstartedonTimeout`)(
