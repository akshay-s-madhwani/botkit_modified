...
module.exports = function beforebotgetstarteddefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`botgetstarted`, `default`, async (convo, bot) => {
      ...
      // map all cms.botgetstarted.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforebotgetstarteddefault`)(
