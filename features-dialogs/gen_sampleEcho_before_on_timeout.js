...
module.exports = function beforesampleEchoonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`sampleEcho`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.sampleEcho.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforesampleEchoonTimeout`)(
