...
module.exports = function beforeqrpayloadonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`qrpayload`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.qrpayload.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeqrpayloadonTimeout`)(
