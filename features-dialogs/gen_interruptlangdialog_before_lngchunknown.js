...
module.exports = function beforeinterruptlangdialoglngchunknown(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interruptlangdialog`, `lngchunknown`, async (convo, bot) => {
      ...
      // map all cms.interruptlangdialog.lngchunknown mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptlangdialoglngchunknown`)(
