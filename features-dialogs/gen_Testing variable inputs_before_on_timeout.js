...
module.exports = function beforeTestingVariableInputsonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Testing variable inputs`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.Testing variable inputs.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeTestingVariableInputsonTimeout`)(
        `before Testing variable inputs all convo.vars : `,
        convo.vars
      );
