...
module.exports = function afterinterruptquitdialog(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`interruptquitdialog`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterinterruptquitdialog`)(
        `interruptquitdialog${strAfterscriptdone}`,
