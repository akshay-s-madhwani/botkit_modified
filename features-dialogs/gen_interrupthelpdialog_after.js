...
module.exports = function afterinterrupthelpdialog(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`interrupthelpdialog`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterinterrupthelpdialog`)(
        `interrupthelpdialog${strAfterscriptdone}`,
