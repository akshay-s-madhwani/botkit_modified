...
module.exports = function beforeFacebookTestdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Facebook_Test`, `default`, async (convo, bot) => {
      ...
      // map all cms.Facebook_Test.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeFacebookTestdefault`)(
