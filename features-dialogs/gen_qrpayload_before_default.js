...
module.exports = function beforeqrpayloaddefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`qrpayload`, `default`, async (convo, bot) => {
      ...
      // map all cms.qrpayload.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeqrpayloaddefault`)(
        `before qrpayload all convo.vars : `,
        convo.vars
      );
