...
module.exports = function beforelngtestonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`lngtest`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.lngtest.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforelngtestonTimeout`)(
        `before lngtest all convo.vars : `,
        convo.vars
      );
