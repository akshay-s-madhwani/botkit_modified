...
module.exports = function beforeinterruptlangdialogonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`interruptlangdialog`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.interruptlangdialog.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeinterruptlangdialogonTimeout`)(
