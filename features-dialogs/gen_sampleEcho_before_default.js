...
module.exports = function beforesampleEchodefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`sampleEcho`, `default`, async (convo, bot) => {
      ...
      const cmstokens = [[`str_sample_message`, {}]];
      ...
      // map all cms.sampleEcho.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforesampleEchodefault`)(
        `before sampleEcho all convo.vars : `,
        convo.vars
      );

      controller.debug(`testing:cms:debug`)(`debug pause sampleEcho`);
