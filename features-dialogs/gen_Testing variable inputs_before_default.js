...
module.exports = function beforeTestingVariableInputsdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Testing variable inputs`, `default`, async (convo, bot) => {
      ...
      // map all cms.Testing variable inputs.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeTestingVariableInputsdefault`)(
