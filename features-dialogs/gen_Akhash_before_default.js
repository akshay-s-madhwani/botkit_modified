...
module.exports = function beforeAkhashdefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`Akhash`, `default`, async (convo, bot) => {
      ...
      // map all cms.Akhash.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforeAkhashdefault`)(
