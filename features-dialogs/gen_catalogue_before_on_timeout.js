...
module.exports = function beforecatalogueonTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`catalogue`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.catalogue.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforecatalogueonTimeout`)(
