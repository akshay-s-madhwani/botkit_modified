...
module.exports = function afterTestHello(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.after(`TestHello`, async (results, bot) => {
      ...
      controller.debug(`testing:after:afterTestHello`)(
        `TestHello${strAfterscriptdone}`,
