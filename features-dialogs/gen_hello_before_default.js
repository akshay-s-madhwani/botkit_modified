...
module.exports = function beforehellodefault(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`hello`, `default`, async (convo, bot) => {
      ...
      const cmstokens = [
        [`str_test1`, { lang: `tobedefinedbycodelang` }],
        [`str_test`, { lang: `tobedefinedbycodelang` }],
      ];
      ...
      // map all cms.hello.default mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforehellodefault`)(
        `before hello all convo.vars : `,
        convo.vars
      );
