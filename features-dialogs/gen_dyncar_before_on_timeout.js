...
module.exports = function beforedyncaronTimeout(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`dyncar`, `on_timeout`, async (convo, bot) => {
      ...
      // map all cms.dyncar.on_timeout mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:beforedyncaronTimeout`)(
