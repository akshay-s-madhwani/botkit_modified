...
module.exports = function replaceFuncName(controller) {
  if (controller.plugins.cms) {
    ...
    controller.plugins.cms.before(`replaceScript`, `replaceThread`, async (convo, bot) => {
      ...
      // map all cms.replaceScript.replaceThread mustache vars | pattern[0]/*pattern*/ | pattern[1]/*sprintf arguments*/
      ...
      controller.debug(`testing:before:replaceFuncName`)(
        `before replaceScript all convo.vars : `,
        convo.vars
      );
